...
def assembly_whole_genome(args):
	...
	pec_genome_cov = int(coverage_Q30)/genome_size
	target_pec_genome_cov = int(target_Q30_coverage)/target_size
	pec_mapped_reads = int(total_reads)/int(WG_mapped_reads)
	pec_target_mapped_reads = int(target_mapped_reads)/int(total_reads)
